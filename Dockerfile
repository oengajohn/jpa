...
ENV JAVA_OPTS -Xms1024M -Xmx2048M -XX:MetaspaceSize=2048M -XX:MaxMetaspaceSize=2048m -XX:CompileThreshold=8000 -Djava.net.preferIPv4Stack=true
...
COPY target/jpa.war /opt/jboss/wildfly/standalone/deployments/